...
| 2 | `gmtime` | `src/ResponseHandler.cpp` | 914 | Not in allowed list |
| 3 | `strftime` | `src/ResponseHandler.cpp` | 916 | Not in allowed list |
...
| 7 | `unlink` | `src/ResponseHandler.cpp` | 809 | Not in allowed list |
